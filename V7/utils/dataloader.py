...
# The version folder and outer BNCI2014001 directory share the workspace root.
# data_process appends the dataset name once more, matching the existing
# workspace layout: BNCI2014001/BNCI2014001/{X.npy,labels.npy}.
DATA_ROOT = Path(__file__).resolve().parents[2] / 'BNCI2014001'
...
def data_process(args, dataset):
    ...
    if 'BNCI2014001' in dataset:
        dataset_dir = DATA_ROOT / 'BNCI2014001'
